...
class LayerManager:
    ...
    LAYER_DEFS = {
        "field": {
            ...
            "geom": "Polygon",
            "fields": [
                QgsField("id", QVariant.String, "text"),
                QgsField("crop", QVariant.String, "text"),
                QgsField("area", QVariant.Double, "double"),
                QgsField("pattern", QVariant.String, "text"),
                QgsField("row_spacing", QVariant.Double, "double"),
        ...
        "junction": {
            ...
            "fields": [
                QgsField("id", QVariant.String, "text"),
                QgsField("elevation", QVariant.Double, "double"),
                QgsField("node_type", QVariant.String, "text"),
            ],
        },
        "emitter": {
            "name": "滴头",
            ...
            "fields": [
                QgsField("id", QVariant.String, "text"),
                QgsField("k", QVariant.Double, "double"),
                QgsField("x", QVariant.Double, "double"),
                QgsField("lateral_id", QVariant.String, "text"),
                QgsField("pressure", QVariant.Double, "double"),
                QgsField("flow", QVariant.Double, "double"),
            ],
        },
        "source": {
            "name": "水源",
            ...
            "fields": [
                QgsField("id", QVariant.String, "text"),
                QgsField("type", QVariant.String, "text"),
                QgsField("head", QVariant.Double, "double"),
                QgsField("flow", QVariant.Double, "double"),
            ],
        },
        "mainline": {
            ...
            "fields": [
                QgsField("id", QVariant.String, "text"),
                QgsField("diameter", QVariant.Double, "double"),
                QgsField("length", QVariant.Double, "double"),
                QgsField("roughness", QVariant.Double, "double"),
                QgsField("flow", QVariant.Double, "double"),
                QgsField("velocity", QVariant.Double, "double"),
            ],
        },
        "submain": {
            "name": "支管",
        ...
        "lateral": {
            ...
            "fields": [
                ...
                QgsField("diameter", QVariant.Double, "double"),
                QgsField("length", QVariant.Double, "double"),
                QgsField("emitter_spacing", QVariant.Double, "double"),
                QgsField("flow", QVariant.Double, "double"),
            ],
        },
        "pump": {
            ...
            "fields": [
                ...
                QgsField("head", QVariant.Double, "double"),
                QgsField("flow", QVariant.Double, "double"),
                QgsField("power", QVariant.Double, "double"),
            ],
        },
        "valve": {
            "name": "阀门",
            ...
            "fields": [
                QgsField("id", QVariant.String, "text"),
                QgsField("type", QVariant.String, "text"),
                QgsField("setting", QVariant.Double, "double"),
            ],
        },
    }
